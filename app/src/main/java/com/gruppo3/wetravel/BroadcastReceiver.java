...
public class BroadcastReceiver extends SMSReceivedServiceListener {
    ...
    public interface OnMessageReceivedListener {
        void onMessageReceived(SMSMessage message, RequestType requestType, @Nullable String[] keys, @Nullable String[] values);
    }

    public static void setDelegate(OnMessageReceivedListener listener) {
